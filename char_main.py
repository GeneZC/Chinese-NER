...
flags.DEFINE_integer("word_dim",    150,        "Embedding size for words")
...
flags.DEFINE_string("word_emb_file",     "word_vectors.txt", "Path for pre_trained word embedding")
